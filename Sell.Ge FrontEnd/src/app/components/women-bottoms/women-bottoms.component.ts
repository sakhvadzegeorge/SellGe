...
import { ShoesService, FilterParams } from '../../services/shoes.service';
...
@Component({
  ...
  templateUrl: './women-bottoms.component.html',
  styleUrls: ['./women-bottoms.component.css']
})
export class WomenBottomsComponent implements  OnInit, OnDestroy {
  shoes: Shoes[] = [];
