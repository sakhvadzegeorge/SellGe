...
@Component({
  ...
  templateUrl: './women-tops.component.html',
  styleUrls: ['./women-tops.component.css']
})
export class WomenTopsComponent implements OnInit, OnDestroy {
  clothes: Clothes[] = [];
